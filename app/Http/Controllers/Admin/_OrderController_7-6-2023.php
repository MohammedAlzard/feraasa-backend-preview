...
//        $your_image = $order->user->avatar;
        ...
        $img = Image::make(public_path('uploads/order_answers/image-service-1.jpg'));
...
//        return $request;
        if ($request->is_active_image && !empty($your_image)) {
            ...
            $img->insert($erweimaimage, 'top', 10, 346);
        }
...
//                        $font->valign('top');
        ...
        $lineHeight = 50;
        $fontColor = '#ffffff';
        $description = $request->language == 'ar' ? $Arabic->utf8Glyphs($request->description,82) : $request->description;
...
//        return $img->response('png');
        ...
        $lineHeight = 50;
        $fontColor = '#ffffff';
        $description = $request->language == 'ar' ? $Arabic->utf8Glyphs($request->description,95) : $request->description;
