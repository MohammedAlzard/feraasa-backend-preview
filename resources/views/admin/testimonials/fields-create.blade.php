...
<div class="form-group col-md-6">
    ...
    {!! Form::text('ar[name]', null, ['class' => 'form-control']) !!}
</div>

<!-- Job Field EN -->
<div class="form-group col-md-6">
    {!! Form::label('job', trans('admin.Job').': ('.trans('admin.English') .')') !!}
    {!! Form::text('en[job]', null, ['class' => 'form-control']) !!}
</div>
<!-- Job Field AR -->
<div class="form-group col-md-6">
    {!! Form::label('job', trans('admin.Job').': ('.trans('admin.Arabic') .')') !!}
    {!! Form::text('ar[job]', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-md-6">
    ...
    {!! Form::textarea('ar[description]', null, ['class' => 'form-control']) !!}
</div>
