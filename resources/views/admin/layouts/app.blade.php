...
<head>
    ...
    <script src="https://kit.fontawesome.com/9df013a202.js" crossorigin="anonymous"></script>
            ...
            <li class="nav-item dropdown user-menu">
                ...
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <li class="user-header bg-green">
                        ...
                        <p>
                            {{ Auth::user()->name }}
                            <small>@lang('admin.member_since') {{ Auth::user()->created_at->format('M. Y') }}</small>
                        </p>
                    </li>
                    <!-- Menu Footer-->
...
<!-- Content Wrapper. Contains page content -->
    ...
    <footer class="main-footer">
        ...
        <strong>
           @lang('admin.Copyright') &copy; {!! date('Y') !!} <a href="{!! url('/') !!}">{!! env('APP_NAME') !!}</a>.
        </strong>
